...
from utils import pyaudio_featurize
import os
import pandas as pd
import shutil

def predictionValue(file):
    features, labels = pyaudio_featurize(file)
...
#             prediction_df = pd.DataFrame({'path':filenames,'age':predictions})
#             print(prediction_df)
